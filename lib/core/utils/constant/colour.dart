...
class TColors {
  // App theme colors
  static Color primary = Color.fromRGBO(84, 61, 133, 1);
  static Color secondary = Color(0xFF49347B);
  static Color accent = Color.fromRGBO(255, 125, 153, 1);
  static Color baseColor = Color(0xFFDCD5E5);
